...
export const reelHtml = (v,i=0) => `<article class="hb-reel" data-reveal style="--i:${i}">
${v.url ? `<video data-src="${e(v.url)}" poster="${e(v.poster)}" muted loop playsinline preload="none" data-lazy aria-label="${e(v.caption || 'Product film')}"></video><button class="hb-reel__play" type="button" aria-label="Play film" data-play-film>Play</button>` : `<img src="${e(v.poster)}" alt="${e(v.caption)}" loading="lazy">`}
